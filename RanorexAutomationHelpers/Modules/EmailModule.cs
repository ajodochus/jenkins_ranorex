...
namespace Ranorex.AutomationHelpers.Modules
{
    ...
    public sealed class EmailModule : ITestModule
    {
        ...
        public EmailModule()
        {
            this.From = "RanorexTester@stp-online.de";
            this.Body = "";
            this.Password = "A(FN09@f!z";
			this.To = "bernd.wissmeier@stp-online.de";
            this.ServerHostname = "KASTPTMX-UTM01.stp.ag";
            this.ServerPort = "25";
            this.Username = "SMTP_RANOREX";
